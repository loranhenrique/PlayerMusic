...
public class telaAplicativo extends AppCompatActivity {
    ...
    private ImageButton btPlay, btPause, btStop, btFavorito;
    private TextView tvBemvindo, tvFavoritos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //colocando nome do usuario
        tvBemvindo.setText("Bem vindo, "+ BancoDeDados.nomeUsuario);
            ...
            public void onClick(View v) {
                if(favoritar == true){
                    Toast.makeText(getApplicationContext(),
                            "Música  desfavoritada!", Toast.LENGTH_SHORT).show();
                    favoritar = false;
                    favoritos --;
                    tvFavoritos.setText("Música(s) favorita(s): " + favoritos);


                }else{
                    favoritos++;
                    Toast.makeText(getApplicationContext(),
                            "Música favoritada!", Toast.LENGTH_SHORT).show();
                    favoritar = true;
                    tvFavoritos.setText("Música(s) favorita(s): " + favoritos);
